...
class CurvedLinearProgressIndicator extends ProgressIndicator {
  ...
  @override
  State<CurvedLinearProgressIndicator> createState() => _CurvedLinearProgressIndicatorState();
}

class _CurvedLinearProgressIndicatorState extends State<CurvedLinearProgressIndicator>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      duration: Duration(
          milliseconds: (widget.animationDuration != null ? widget.animationDuration!.inMilliseconds * 1333 : null) ??
  ...
  Widget _buildIndicator(BuildContext context, double animationValue, TextDirection textDirection) {
    ...
    final double minHeight = widget.minHeight ?? widget.strokeWidth ?? indicatorTheme.linearMinHeight ?? 4.0;
...
class CurvedCircularProgressIndicator extends ProgressIndicator {
  ...
  @override
  State<CurvedCircularProgressIndicator> createState() => _CurvedCircularProgressIndicatorState();
}

class _CurvedCircularProgressIndicatorState extends State<CurvedCircularProgressIndicator>
    with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(
      duration: Duration(
          milliseconds: (widget.animationDuration != null ? widget.animationDuration!.inMilliseconds * 2222 : null) ??
...
class _RefreshProgressIndicatorPainter extends _CurvedCircularProgressIndicatorPainter {
...
class RefreshProgressIndicator extends CurvedCircularProgressIndicator {
  ...
  const RefreshProgressIndicator({
    ...
    Color? color,
    Animation<Color?>? valueColor,
    double? strokeWidth, // Different default than CurvedCircularProgressIndicator.
    String? semanticsLabel,
    String? semanticsValue,
  }) : super(
          key: key,
  ...
  @override
  State<CurvedCircularProgressIndicator> createState() => _RefreshProgressIndicatorState();
}

class _RefreshProgressIndicatorState extends _CurvedCircularProgressIndicatorState {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return _buildMaterialIndicator(
          ...
          1.05 * _CurvedCircularProgressIndicatorState._strokeHeadTween.evaluate(_controller),
          _CurvedCircularProgressIndicatorState._strokeTailTween.evaluate(_controller),
          _CurvedCircularProgressIndicatorState._offsetTween.evaluate(_controller),
          _CurvedCircularProgressIndicatorState._rotationTween.evaluate(_controller),
        );
      },
    );
  }
